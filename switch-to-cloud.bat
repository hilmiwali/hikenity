@echo off
REM Switch backend to CLOUD (production/deployed backend)

echo Switching to CLOUD backend...
echo.

set /p CLOUD_URL="Enter your deployed backend URL (e.g., https://hikenity-backend.herokuapp.com): "
...
echo # CLOUD/PRODUCTION CONFIGURATION
echo.
echo # ======================
...
echo.
echo ✅ Switched to CLOUD backend: %CLOUD_URL%
echo.
